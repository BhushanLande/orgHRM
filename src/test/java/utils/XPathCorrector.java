...
public class XPathCorrector {

        public static void main(String[] args) {

            String apiKey = "sk-proj-Nq_text";
            String brokenXPath = "//input[@class='username']";
            ...
            // Parse response JSON to extract corrected XPath
